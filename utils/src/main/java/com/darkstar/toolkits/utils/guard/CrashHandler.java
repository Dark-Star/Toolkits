package com.darkstar.toolkits.utils.guard;

import android.content.Context;
import android.content.Intent;
import android.text.TextUtils;

import com.darkstar.toolkits.utils.io.FileUtils;
import com.darkstar.toolkits.utils.logger.LogcatHelper;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        FileUtils.writeStr2File(LogcatHelper.readThrowable(ex), crashFile);
